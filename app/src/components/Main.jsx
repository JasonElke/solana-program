...
export default function Main({ network, voteAccount }) {
  ...
  useEffect(() => {
    ...
    async function getVotes() {
      ...
      try {
        ...
        setVotes({
          alice: parseInt(account.alice.toString()),
          bob: parseInt(account.bob.toString()),
        });
      } catch (error) {
  ...
  // Vote for either alice or bob. Poll for updated vote count on completion
      ...
      <Box flex="1 0 auto">
        ...
        <Container>
          <Grid container spacing={3}>
            ...
            <Grid item xs={6}>
              <VoteOption side="alice" handleVote={handleVote} />
            </Grid>
            <Grid item xs={6}>
              <VoteOption side="bob" handleVote={handleVote} />
            </Grid>
            <Grid item xs={12}>
